...
window.__HOME__ = {
  ...
  "content": {
    ...
    "about": {
      "textHtml": "기능의 수가 아니라,\n사용자가 체감하는 가치로 판단합니다.",
      "sub": "<ul class=\"about-facts\"><li>삼성생산기술연구소 · 스마트팩토리 프로젝트 (우수상 - 2025.05)</li><li>SSAFY AI · SW 아카데미 (2024.07 – 2025.06)</li><li>숭실대학교 (2019 – 2024)</li><li>해커스교육그룹 기획 인턴 (2022)</li><li>Saint Louis University (2016 - 2018)</li><li>SQLD · ADsP</li></ul>",
      "photoSrc": "assets/images/profile/taegeon.jpg",
      "photoAlt": "Taegeon Park"
    },
    "skills": {
      "subtitle": "Skills",
      "text": "사용자 경험과 데이터를 기준으로 생각하고,\n주인의식을 가지고 직접 검증합니다.",
      "groups": [
        {
          "id": "develop",
          "title": "Develop",
