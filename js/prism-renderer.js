/**
 * Aerukart-inspired rotating glass prism hero (replaces CoreRenderer)
 */
(function () {
  const PrismRenderer = {
    _inited: false,
    ...
    init(containerId = 'hero-canvas') {
      if (this._inited || typeof THREE === 'undefined') return Promise.resolve();
      ...
      const light3 = new THREE.AmbientLight(0x7873f5, 0.35);
      ...
      const bgMat = new THREE.ShaderMaterial({
        ...
        fragmentShader: `
          ...
          void main() {
            ...
            vec3 c1 = vec3(1.0, 0.43, 0.78);
            vec3 c2 = vec3(0.47, 0.45, 0.96);
